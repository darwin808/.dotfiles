...
exports.printStatsToClientOutputChannel = exports.printNoFileOpenMessage = exports.timeSince = void 0;
...
const printNoFileOpenMessage = (client, extVersion) => {
    client.outputChannel.appendLine("------------------------------");
    client.outputChannel.appendLine(`🚀 Apollo GraphQL v${extVersion}`);
    client.outputChannel.appendLine("------------------------------");
};
exports.printNoFileOpenMessage = printNoFileOpenMessage;
const printStatsToClientOutputChannel = (client, stats, extVersion) => {
    client.outputChannel.appendLine("------------------------------");
    client.outputChannel.appendLine(`🚀 Apollo GraphQL v${extVersion}`);
    client.outputChannel.appendLine("------------------------------");
...
exports.printStatsToClientOutputChannel = printStatsToClientOutputChannel;
