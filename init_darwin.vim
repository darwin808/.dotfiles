...
nnoremap <silent><leader>fo <cmd>lua vim.lsp.buf.formatting_sync(nil, 300)<CR>
autocmd BufWritePre *.js lua vim.lsp.buf.formatting_sync(nil, 300)
autocmd BufWritePre *.ts lua vim.lsp.buf.formatting_sync(nil, 300)
autocmd BufWritePre *.tsx lua vim.lsp.buf.formatting_sync(nil, 300)
